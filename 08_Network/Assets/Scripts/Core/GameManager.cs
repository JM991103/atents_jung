...
public class GameManager : NetSingleton<GameManager>
{
    ...
    protected override void Initialize()
    {
        ...
        disconnectName.OnValueChanged += OnplayerDisconnected;  // 값이 변경될 때 실행될 함수 등록
    }
    ...
    public Vector3 GetRandomSpawnPosition()
    {
        ...
        if(Physics.Raycast(origin, Vector3.down, out RaycastHit hit, 150.0f, LayerMask.GetMask("Environment")))
        {
            result = hit.point;
        }
        return result;
