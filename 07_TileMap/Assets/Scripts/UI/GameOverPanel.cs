...
public class GameOverPanel : MonoBehaviour
{
    ...
    /// 전체 플레이 시간 표시용 텍스트
    /// </summary>
    TextMeshProUGUI totlaPlayTimeText;
    ...
    private void Awake()
    {
        ...
        totlaPlayTimeText = child.GetComponent<TextMeshProUGUI>();
    ...
    /// 플레이어가 죽었을 때 실행되는 함수
    /// </summary>
    /// <param name="totalPlayTime">플레이어가 시작부터 죽을 때까지 걸린 총 플레이 시간</param>
    ...
    {
        while (canvasGroup.alpha < 1.0f)    // 알파가 1이 될때까지
        {
